...
class Oembed extends Service_Base {
	 ...
	 */
	public function filter_embed_template( string $template ) {
	 ...
	 */
	public function filter_embed_html( string $output, $post, int $width, int $height ) {
	 ...
	 */
	public function filter_oembed_response_data( array $data, $post, int $width ) {
		if ( Story_Post_Type::POST_TYPE_SLUG !== $post->post_type ) {
			return $data;
		}
	 ...
	 * @return array
	 */
	protected function get_embed_height_width( int $old_width ) {
